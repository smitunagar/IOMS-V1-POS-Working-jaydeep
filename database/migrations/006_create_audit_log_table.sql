...
-- This migration creates the audit_log table to track all changes in the system
...
CREATE INDEX IF NOT EXISTS idx_audit_log_change_by ON audit_log(change_by);
...
CREATE INDEX IF NOT EXISTS idx_audit_log_user_operation ON audit_log(user_id, operation);
CREATE INDEX IF NOT EXISTS idx_audit_log_table_operation ON audit_log(table_name, operation);
CREATE INDEX IF NOT EXISTS idx_audit_log_created_at_operation ON audit_log(created_at, operation);
