...
export default function SettingsPage() {
  ...
  useEffect(() => {
    try {
      ...
      const settingsKey = `app_settings_${userId}`;
  ...
  const paymentPlans = [
    {
      ...
      price: '€49',
      period: 'per month',
      description: 'Essential tools for single-location restaurants',
      features: ['Up to 2 registers', 'Core analytics dashboard', 'Standard support'],
      highlight: false,
    },
    {
      id: 'professional',
      ...
      price: '€89',
      period: 'per month',
      description: 'Advanced workflow automations and insights',
      features: ['Unlimited registers', 'AI waste forecasting', 'Priority support', 'Hardware integration'],
      highlight: true,
    },
    {
      id: 'enterprise',
      ...
      description: 'Multi-location control with dedicated success manager',
      features: ['Bespoke onboarding', 'Advanced permissions', 'Dedicated success manager', 'Quarterly strategy review'],
      highlight: false,
    },
  ];
